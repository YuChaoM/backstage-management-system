  ...
  <div style="color: #666666">
    <el-row :gutter="20">
      <el-col :span="16">
        <div style="margin: 10px 0;">
          <el-input class="ml-5" style="width: 300px" placeholder="请输入名称" suffix-icon="el-icon-search"
    ...
    <div style="margin: 10px 0">
      <div style="padding: 20px 0;border-bottom: 1px dashed #cccccc" v-for="item in tableData" :key="item.id">
        <div class="pd-10" style="font-size: 20px;color: #409EFF; cursor: pointer" @click="$router.push('/front/articleDetail?id='+ item.id)">{{ item.name }}</div>
